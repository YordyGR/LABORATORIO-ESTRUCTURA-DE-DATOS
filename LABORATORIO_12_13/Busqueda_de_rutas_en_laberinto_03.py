...
def bfs_laberinto(laberinto, inicio, destino):
    ...
    while cola:
        ...
        for direccion in direcciones:
            ...
            if nueva_celda[0] < 0 or nueva_celda[0] >= len(laberinto) or nueva_celda[1] < 0 or nueva_celda[1] >= len(laberinto[0]) or laberinto[nueva_celda[0]][nueva_celda[1]] == '#' or nueva_celda in visitado:
                continue
